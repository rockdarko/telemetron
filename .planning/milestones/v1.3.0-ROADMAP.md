...
- [x] **Phase 15: Documentation Cascade** — Gate 11 in `roles/README.md`; `docs/quickstart.md` `## Backup and restore` section + root README cross-ref; per-stateful-role README `## Backup` H2 sections; stateless role README one-liners (3 requirements: DOCS-V13-01..03) (completed 2026-06-05)
...
**Plans**: 3 plans
- [x] 15-01-PLAN.md — docs/quickstart.md ## Backup and restore H2 section (5 sub-H3s; closes DOCS-V13-02 main clause)
- [x] 15-02-PLAN.md — Per-role README ## Backup sections — 4 stateful (uniform skeleton) + 8 stateless (two-template one-liner) — 12 README files (closes DOCS-V13-03)
- [x] 15-03-PLAN.md — Root README "When something goes wrong" cross-ref + roles/README.md Gate 11 (closes DOCS-V13-01 + DOCS-V13-02 root clause)
